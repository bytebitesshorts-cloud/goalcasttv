...
const values = [
  {
    icon: Globe2,
    title: 'Global Access',
    desc: 'We believe sports should be borderless. GoalCast brings channels from every corner of the world into one place.',
  },
  {
    icon: Zap,
    title: 'Always Fast',
    desc: 'Our lightweight interface loads instantly on any device, from the latest flagship phone to an old laptop.',
  },
  {
    icon: Heart,
    title: 'Truly Free',
    desc: 'No subscriptions, no sign-ups, no paywalls. GoalCast will always be free for everyone.',
  },
  {
    icon: Users,
    title: 'Community Powered',
    desc: 'Our stream sources are powered by the open-source IPTV community. We stand on the shoulders of giants.',
  },
];
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="text-center mb-16">
        ...
        <p className="text-lg text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          GoalCast was built with a simple mission: give every sports fan on Earth access to live sports TV — for free, forever, with no strings attached.
        </p>
      </section>
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-16">
        {stats.map(s => (
          <div key={s.label}
            className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 text-center hover:border-emerald-500/40 transition-colors">
            <p className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-400">
              {s.value}
            </p>
      ...
      <section className="mb-16">
        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none space-y-4 text-zinc-600 dark:text-zinc-400 leading-relaxed">
          ...
          <p>
            Today, GoalCast serves sports fans worldwide who want to watch football, cricket, basketball, tennis, F1, and more without paying a premium. We&apos;re constantly improving — adding channels, fixing streams, and building new features.
          </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {values.map(v => {
            ...
            return (
              <div key={v.title}
                className="flex gap-4 p-5 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl hover:border-emerald-500/40 transition-colors">
      ...
      <section className="text-center p-8 bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/20 rounded-3xl">
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-3">Ready to watch?</h2>
        <p className="text-zinc-500 dark:text-zinc-400 mb-6">Browse 1,100+ channels from 80+ countries — completely free.</p>
        <Link href="/"
          className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-bold rounded-xl transition-all shadow-lg shadow-emerald-500/20 hover:-translate-y-0.5">
